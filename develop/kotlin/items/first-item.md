---
title: Creating Your First Item - Kotlin Version
...
@[code transcludeWith=:::1](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)
...
@[code transcludeWith=:::2](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)
...
@[code transcludeWith=:::3](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)

@[code transcludeWith=:::1](@/reference/latest/src/main/kotlin/com/example/docs/item/ExampleModItems.kt)
...
@[code transcludeWith=:::4](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)
...
@[code transcludeWith=:::\_10](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)

Alternatively, if you want to make your item a fuel, you can use the `FuelRegistryEvents.BUILD` event:

@[code transcludeWith=:::\_11](@/reference/latest/src/main/kotlin/com/example/docs/item/ModItems.kt)
...
@[code lang=java transcludeWith=:::3](@/reference/latest/src/main/kotlin/com/example/docs/item/custom/LightningStick.java)
